...
def list_cupcakes():
    ...
    Return JSON like:
        {cupcakes:[{id, flavoe, rating, size, image}, ...]}
        """
    
    cupcakes =[cupcake.to_dist() for cupcake in Cupcake.query.all()]
...
def get_cupcake(cupcake_id):
    ...
    return jsonify(cupcake=cupcake.to_dist())
...
def remove_cupcake(cupcake_id):
    """Delete cupcake and return confirmatin message.
